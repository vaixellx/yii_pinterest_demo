...
/**
 * This is the model class for table "pin_item_liked_users".
 *
 * The followings are the available columns in table 'pin_item_liked_users':
 * @property string $id
...
class PinItemLikedUser extends CActiveRecord
{
	 ...
	 * @return PinItemLikedUser the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, pin_item_id', 'safe', 'on'=>'search'),
		);
	}
